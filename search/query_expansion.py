...
_CA_TO_ES = {
    ...
    # TRAMVIA (POST-EVAL)
    "tramvia": ["tranvia", "tren ligero"],
    "plataforma reservada": ["plataforma reservada", "via reservada"],
    "superestructura tramvia": ["superestructura tranvia", "via tranviaria"],
    "parada tramvia": ["parada tranvia", "estacion tranvia"],
    "galib tramviari": ["galibo tranviario"],
    "catenaria tramvia": ["catenaria tranviaria"],
    "interseccio tramvia": ["cruce tranviario", "interseccion tranviaria"],
    "prioritat semaforica": ["prioridad semaforica"],
    # AUTOBUS / ESTACIONS (POST-EVAL)
    "autobus": ["autobus"],
    "estacio autobusos": ["estacion autobuses", "terminal autobuses"],
    "marquesina": ["marquesina", "cubierta parada"],
    "darsena": ["darsena"],
    "parada bus": ["parada autobus", "parada bus"],
    "zona d'espera": ["zona de espera", "sala de espera"],
    "intercambiador": ["intercambiador", "intercambiador modal"],
    "transport public": ["transporte publico"],
    # APARCAMENTS (POST-EVAL)
    "aparcament soterrat": ["aparcamiento subterraneo", "aparcamiento bajo rasante"],
    "aparcament en superficie": ["aparcamiento en superficie"],
    "cotxera": ["cochera", "deposito vehiculos"],
    "parc de vehicles": ["parque de vehiculos", "deposito de vehiculos", "cocheras"],
    "rampa aparcament": ["rampa aparcamiento", "rampa de acceso"],
    "ventilacio aparcament": ["ventilacion aparcamiento", "ventilacion garaje"],
    "deteccio co": ["deteccion co", "deteccion monoxido"],
    "sprinklers": ["rociadores", "sprinklers"],
    "bie": ["boca de incendio equipada", "bie"],
    "exutori": ["exutorio", "ventilacion natural incendios"],
    # CTE DOCUMENTS BASICS (POST-EVAL)
    "proteccio incendis": ["proteccion incendios", "DB-SI", "CTE DB-SI"],
    "seguretat incendi": ["seguridad incendio", "DB-SI"],
    "seguretat us": ["seguridad utilizacion", "DB-SUA", "CTE DB-SUA"],
    "estalvi energia": ["ahorro energia", "DB-HE", "CTE DB-HE"],
    "salubritat": ["salubridad", "DB-HS", "CTE DB-HS"],
    "proteccio soroll": ["proteccion ruido", "DB-HR", "CTE DB-HR"],
    "seguretat estructural": ["seguridad estructural", "DB-SE", "CTE DB-SE"],
    # TERMES GENERICS (POST-EVAL)
    "obra publica": ["obra publica"],
    "annex normatiu": ["anejo normativo", "anexo normativo"],
    "pla d'obra": ["plan de obra", "programa de trabajos"],
    "termini execucio": ["plazo ejecucion"],
    "recepcio obra": ["recepcion obra"],
    "garantia": ["garantia"],
    "assaig": ["ensayo"],
    "assaigs": ["ensayos"],
    "laboratori": ["laboratorio"],
    "coordinador seguretat": ["coordinador seguridad"],
}
